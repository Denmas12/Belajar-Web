		...
		<form action="proses.php?aksi=update" method="POST" enctype="multipart/form-data">
			<table class="form-input">
				...
				<tr>
					...
					<td><input type="text" name="judul" value="<?php echo $data['judul'];?>" placeholder="Masukkan Judul" class="kotak-input" required></td>
				</tr>
				<tr>
					<td class="kolom-1 artikel">artikel</td>
					<td><textarea rows="4" name="isi" placeholder="Masukkan Artikel" class="kotak-textarea" required><?php echo $data['isi'];?></textarea></td>
				</tr>
				<tr>
					<td class="kolom-1">foto</td>
					<td><input type="file" name="foto" class="kotak-input-tombol"></td>
				</tr>
				<tr>
